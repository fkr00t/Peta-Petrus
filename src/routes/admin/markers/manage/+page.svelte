        ...
        {#if selectedView === 'cards'}
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {#each getFilteredMarkers() as marker (marker.id)}
              <div class="bg-white/60 dark:bg-gray-800/60 backdrop-blur-sm rounded-2xl shadow-lg border border-white/20 dark:border-gray-700/30 overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group">
                <!-- Card Header -->
                <div class="relative">
                  {#if marker.imageUrl}
                ...
                <div class="p-6">
                  ...
                  <div class="flex items-center space-x-3 mb-4">
                    ...
                    {#if marker.city}
                      <div class="text-xs bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-2 py-1 rounded-full">
                        📍 {marker.city}
                      </div>
                    {/if}
                  </div>
      ...
      <div class="p-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-4 border border-gray-200 dark:border-gray-700 mb-4">
          <div class="flex items-start space-x-3">
            ...
            {/if}
            <div class="flex-1 min-w-0">
              <h4 class="font-semibold text-gray-900 dark:text-white mb-1">{markerToDelete.title}</h4>
              ...
              <div class="flex items-center space-x-2 mt-2">
                ...
                {#if markerToDelete.city}
                  <span class="text-xs bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-2 py-1 rounded-full">
                    📍 {markerToDelete.city}
                  </span>
                {/if}
              </div>
