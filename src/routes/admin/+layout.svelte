...
<div class="flex h-screen bg-gray-100 dark:bg-gray-900">
  ...
  <aside class={`${showSidebar ? 'translate-x-0' : '-translate-x-full'} fixed inset-y-0 z-50 flex flex-col w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-md transition-transform duration-300 ease-in-out md:translate-x-0 md:static md:z-auto`}>
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700">
      ...
      <button onclick={toggleSidebar} class="md:hidden text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" aria-label="Tutup sidebar">
  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <header class="bg-white dark:bg-gray-800 shadow-sm z-10">
      <div class="px-4 py-3 flex items-center justify-between">
        <!-- Mobile Menu Button -->
        <button onclick={toggleSidebar} class="md:hidden text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200" aria-label="Buka sidebar">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
