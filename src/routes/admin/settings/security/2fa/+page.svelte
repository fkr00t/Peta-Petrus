...
<svelte:head>
  <title>Pengaturan 2FA - Panel Admin</title>
  <meta name="description" content="Pengaturan autentikasi dua faktor untuk keamanan akun admin" />
</svelte:head>
...
<div class="p-6">
  <div class="mb-8">
    ...
    <p class="mt-2 text-gray-600 dark:text-gray-400">
      Tingkatkan keamanan akun admin Anda dengan menambahkan lapisan perlindungan ekstra
    </p>
  </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
      <div class="flex items-center mb-4">
        ...
        <div>
          ...
          <p class="text-sm text-gray-600 dark:text-gray-400">Akun admin Anda dilindungi dengan lapisan keamanan tambahan</p>
        </div>
      </div>
  ...
  {:else}
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
      <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Tingkatkan Keamanan Akun Admin</h2>
